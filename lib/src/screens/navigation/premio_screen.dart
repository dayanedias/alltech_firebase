...
class PremioScreen extends StatefulWidget {
  @override
  _PremioScreenState createState() => _PremioScreenState();
}
...
class _PremioScreenState extends State<PremioScreen> {
  ...
  Widget build(BuildContext context) {
   // final premioP = Provider.of<PremioProvider>(context);
          ...
          child: Container(
            child: Column(
              children: [
                ...
                Text(
                  "Premiação - ${regionalSelecionada == "Regionais" ? "Geral" : "Regional ${regionalSelecionada}"}",
                  style: TextStyle(
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: ListView.builder(
                        itemCount: 9,//premioP.premio.length,
                        shrinkWrap: true,
